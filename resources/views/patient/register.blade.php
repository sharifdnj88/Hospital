								...
								<div class="col-md-12 col-lg-6 login-right  shadow">
									...
									<form action="{{route('patient.store')}}" method="POST">
										...
										<div class="row form-row social-login">
                                            <div class="col-4">
                                                <a href="{{route('facebook.login')}}" class="btn btn-facebook btn-block"><i class="fab fa-facebook-f mr-1"></i> Login</a>
                                            </div>
                                            <div class="col-4">
                                                <a href="{{route('google.login')}}" class="btn btn-google btn-block"><i class="fab fa-google mr-1"></i> Login</a>
                                            </div>
                                            <div class="col-4">
                                                <a href="{{route('github.login')}}" class="btn btn-github btn-block bg-info text-white"><i class="fab fa-github mr-1"></i> Login</a>
                                            </div>
                                        </div>
									</form>
									<!-- /Register Form -->
